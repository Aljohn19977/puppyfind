...
$('#modal-batch').modal('show');
  ...
  $('#batch_history_table').DataTable({
                  ...
                  autoWidth: true,
                  ajax: {
                          'url' : "{{ route('receiving.api_get_batch_history')}}",
                          'dataType' : 'json',
                          'type' : 'post',
                          'data' : {
  ...
  $('#add_batch_id').on('click', function(e){
      ...
      $.ajax({
        ...
        data:{
            ...
            "remaining_quantity" :  $('#item_quantity').text(),
...
$('#reset_batch_id').on('click', function(e){
    get_batch_id();
    clearError();
    $('#batch_name').val('')
    $('#expiration_date2').val('')
    $("#expiration_date2").attr("disabled",false)

});

  $(document).on('click', '#batch_id_select', function(){
    ...
    $.ajax({
        type: 'get',
        dataType: 'JSON',
        url: "/receiving/batch_info/"+$(this).data().id,
        success: function(data) {
          $("#modal_loader2").attr("hidden",true)
          $("#expiration_date2").attr("disabled",true)
          $('#batch_name').val(data.name)
          $('#expiration_date2').val(data.expiration_date)
          $('#batch_id').val(data.batch_id)
        },
        error: function(error){
              Toast.fire({
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        <div class="card">
                          <div class="card-header p-2">
                            <ul class="nav nav-pills">
                              <li class="nav-item"><a class="nav-link active" href="#batch_list" data-toggle="tab">Batch List</a></li>
                              <li class="nav-item"><a class="nav-link" href="#batch_history" data-toggle="tab">Batch Log</a></li>
                            </ul>
                          </div><!-- /.card-header -->
                          <div class="card-body">
                            <div class="tab-content">
                              <div class="active tab-pane" id="batch_list">
                                <div class="row">
                                  <div class="col-3">
                                  ...
                                  <div class="col-2">
                                    <div class="form-group" id="quantity_this">
                                  ...
                                  <div class="col-2">
                                    ...
                                    <button class="btn btn-danger" id="reset_batch_id"><i class="fas fa-undo-alt"></i></button>
                                  </div>
                                </div>
                              ...
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="batch_history">
                                <table class="table" id="batch_history_table" style="width:100%;">
                                  <thead>
                                    <tr>
                                      <th>Batch ID</th>
                                      <th>Name</th>
